  ...
  return (
    <AppLayout>
      <Switch>
        ...
        <Route path="/generate">{() => <ComingSoon title="Generate Article" description="Create high-quality, SEO-optimized articles with AI assistance." />}</Route>
        <Route path="/articles">{() => <ComingSoon title="Articles" description="Manage all your articles, drafts, and published content." />}</Route>
