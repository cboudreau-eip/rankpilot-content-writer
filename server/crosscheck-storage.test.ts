...
describe("crossCheck dual-storage: updateReferenceDoc", () => {
  it("saves content to both DB and S3 on update", async () => {
...
describe("crossCheck dual-storage: getReferenceDoc", () => {
  ...
  it("falls back to S3 when DB content is null", async () => {
    const ctx = createAuthContext();
    const caller = appRouter.createCaller(ctx);
...
describe("crossCheck dual-storage: checkArticle", () => {
